...
- [So what is "standard"?](#so-what-is-standard)
- [Notation](#notation)
- [Where are all the grammar tables?](#where-are-all-the-grammar-tables)
...
Source: [Z-Machine Standards Document - Preface](https://zspec.jaredreisinger.com/001-preface)
