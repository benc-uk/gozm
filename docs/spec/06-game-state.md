...
After a "restore" or "undo", an interpreter should reset the header values marked Rst in the header table of S11. (It should not be assumed that the game was saved by the same interpreter.)
...
_Source: [Z-Machine Standards Document - Section 6](https://zspec.jaredreisinger.com/06-game-state)_
